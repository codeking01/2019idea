...
class CourseInfo(models.Model):
    ...
    lever = models.CharField(choices=(('gj', '高级'), ('zj', '中级'), ('cj', '初级')), max_length=5, verbose_name="课程难度",
                             default='cj')
...
class VideoInfo(models.Model):
    ...
    url = models.URLField(default='https://www.bilibili.com', verbose_name="视频链接", max_length=200)
...
class SourceInfo(models.Model):
    ...
    # 会放在static下的source文件下  这个必须写FileField 直接下载到本地了
    down_load=models.FileField(upload_to='sourse/',max_length=200,verbose_name="下载路径")
    courseinfo=models.ForeignKey(CourseInfo,verbose_name="所属课程",on_delete=models.CASCADE)
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
