    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lever', models.CharField(choices=[('gj', '高级'), ('zj', '中级'), ('cj', '初级')], default='cj', max_length=5, verbose_name='课程难度')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(default='https://www.bilibili.com', verbose_name='视频链接')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('down_load', models.FileField(max_length=200, upload_to='sourse/', verbose_name='下载路径')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('courseinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.courseinfo', verbose_name='所属课程')),
            ],
            options={
